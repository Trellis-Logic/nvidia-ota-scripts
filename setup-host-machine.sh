...
base_bsp_version="R32-7"
target_release="35.1.0"
base_release_tarball=jetson_linux_r${base_release}_aarch64.tbz2
base_release_tarball_wget=https://developer.nvidia.com/embedded/l4t/r32_release_v7.2/t186/${base_release_tarball}
base_release_rootfs_tarball=tegra_linux_sample-root-filesystem_r${base_release}_aarch64.tbz2
base_release_rootfs_tarball_wget=https://developer.nvidia.com/embedded/l4t/r32_release_v7.2/t186/${base_release_rootfs_tarball}
...
set -e
export BASE_BSP=$(pwd)/workdir/base/Linux_for_Tegra
export TARGET_BSP=$(pwd)/workdir/target/Linux_for_Tegra
out_dir=$(pwd)/workdir/output
dl_dir=~/nvidia/Downloads/nvidia/sdkm_downloads
if [ ! -e ${BASE_BSP}/apply_binaries.sh ]; then
